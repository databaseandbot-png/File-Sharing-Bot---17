...
Davi_DEV = Tom_Botz
file_auto_delete = humanize.naturaldelta(Davi_DEV)
...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        Davi_MSG = [] # List to keep track of sent messages
        ...
        asyncio.create_task(delete_files(Davi_MSG, client, k))
        ...
        reply_markup = InlineKeyboardMarkup([[
            InlineKeyboardButton("⚔️Update Channel", url="https://t.me/orewa_void"),
            InlineKeyboardButton("🛡️Support Group", url="https://t.me/orewa_gaban")
            ],[
